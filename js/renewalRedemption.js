...
class RenewalRedemptionManager {
  ...
  loadInitialRenewals() {
    ...
    const seedRenewals = [
      {
        renewalId: 'REN-2026-000012',
        oldTicketNo: 'PLG-2025-001920',
        newTicketNo: 'PLG-2026-002340',
        customerId: 'CUS-2026-000092',
        interestSettled: 18000,
        principalCarried: 150000,
        renewalDate: '2025-08-28',
        newMaturityDate: '2026-08-28',
        createdBy: 'ADMIN'
      }
    ];
    this.saveRenewals(seedRenewals);
    return seedRenewals;
  }
  ...
  loadInitialRedemptions() {
    ...
    const seedRedemptions = [
      {
        redemptionId: 'RED-2026-000045',
        ticketNo: 'PLG-2025-001880',
        customerId: 'CUS-2026-000184',
        principalSettled: 50000,
        interestSettled: 2500,
        totalSettlement: 52500,
        paymentMode: 'CASH',
    ...
    this.saveRedemptions(seedRedemptions);
    return seedRedemptions;
  }
