...
const translations = {
  en: {
    ...
    data_health: 'Data Health & Backups',
    settings: 'Settings',
    logout: 'Logout',
    online: 'Online',
    ...
    kpi_today_renewals: "Renewals Today",
    ...
    kpi_due_3days: 'Due in Next 3 Days',
    kpi_due_7days: 'Due in Next 7 Days',
    kpi_overdue: 'Overdue Loans (>12 Mo)',
    kpi_missing_kyc: 'Missing KYC ID',
    kpi_missing_customer_photo: 'Missing Customer Photo',
    kpi_missing_pledge_photo: 'Missing Pledge Photo',
    kpi_offline_queue: 'Offline Queue',
    kpi_failed_sync: 'Failed Sync',
    kpi_rate_update: 'Rate Status',
    kpi_backup_status: 'Backup Status',
    omni_search_placeholder: 'Search ticket #, borrower name, mobile, Aadhaar, packet ID...',
    quick_new_customer: '+ New Customer',
    quick_new_pledge: '+ New Pledge',
    quick_payment: 'Payment',
    quick_redemption: 'Redemption',
    quick_renewal: 'Renewal',
    quick_search: 'Search',
    system_health_title: 'System Health & Diagnostics',
    document_alerts_title: 'Document & Compliance Alerts',
    rate_ticker_title: 'Live Metal Rates',
    ...
    retake_photo: 'Retake',
    confirm_photo: 'Confirm & Save Photo',
    cancel_photo: 'Cancel',
    take_snapshot: 'Take Snapshot',
    camera_permission_denied: 'Camera permission denied or camera not available. Please allow camera access or use the file upload option.',
    customer_photo_updated: 'Customer photograph updated successfully',
    photo_sync_pending: 'Photo saved locally (Pending Cloud Sync)',
    photo_sync_success: 'Photo uploaded to Google Drive',
    no_camera_available: 'No camera detected on this device. Please upload a photo from file.',
    align_face_guide: 'Align customer face within the oval guide',
    ...
    payment_methods_desc: 'Enable or disable payment methods, customize display labels, and set reference / note requirements.',
    enable_payment_method: 'Enable Method',
    method_code: 'Method Code',
    method_label_en: 'Display Label (English)',
    method_label_ta: 'Display Label (Tamil)',
    ref_rule: 'Reference Number Rule',
    ref_optional: 'Optional',
    ref_recommended: 'Recommended',
    ref_required: 'Strictly Required',
    notes_rule: 'Notes / Remarks Rule',
    notes_optional: 'Optional',
    notes_required: 'Strictly Required',
    mode_cash: 'Cash (ரொக்கம்)',
    mode_upi: 'UPI (GPay / PhonePe / Paytm)',
    mode_bank: 'Bank Transfer (IMPS / NEFT)',
    mode_bank_transfer: 'Bank Transfer (IMPS / NEFT / RTGS)',
    mode_card: 'Card (Debit / Credit)',
    mode_other: 'Other Method',
    collections_by_method: "Today's Collections by Payment Method",
    col_cash: 'Cash Collections',
    col_upi: 'UPI Collections',
    col_bank: 'Bank Transfer Collections',
    col_card: 'Card Collections',
    col_other: 'Other Collections',
    err_ref_required: 'Reference number is strictly required for this payment method',
    err_notes_required: 'Notes / Remarks are strictly required for this payment method',
    err_no_payment_method: 'At least one payment method must remain active',
    ...
    // Advanced Valuation & Appraiser Fee Terms
    valuation_settings: 'Valuation & Appraiser Fee Settings',
    gold_appraiser_fee: 'Gold Appraiser Fee',
    other_configured_fee: 'Other Configured Fee',
    gross_estimated_value: 'Gross Estimated Value',
    gross_eligible_value: 'Gross Eligible Value',
    less_fees: 'Less Fees (-)',
    net_eligible_value: 'Net Eligible Value',
    ltv_percent: 'Loan-to-Value (LTV %)',
    max_loan: 'Maximum Eligible Loan',
    approved_pledge_amount: 'Approved Pledge Amount',
    net_disbursed_cash: 'Net Cash Disbursed',
    fee_deduction_mode: 'Fee Collection Method',
    deduct_from_disbursement: 'Deduct from Disbursement',
    collect_separately: 'Collect Separately at Counter',
    appraiser_fee_type: 'Appraiser Fee Type',
    fee_type_fixed: 'Fixed Amount (₹)',
    fee_type_percentage: 'Percentage (%)',
    fee_type_none: 'No Fee (₹0)',
    allow_per_pledge_custom_fee: 'Allow Per-Pledge Fee Adjustment',
    fee_deducted_disbursement_note: 'Appraiser Fee deducted from loan disbursement',
    fee_collected_counter_note: 'Appraiser Fee collected separately at counter',
    ...
    // Document Repository & KYC Scanning Terms
    doc_repository: 'Secure Document Repository',
    upload_doc: 'Upload / Scan Document',
    scan_document: 'Scan / Capture Document',
    document_scanner: 'Document Scanner & Camera Device',
    type_aadhaar: 'Aadhaar Card (ID Proof)',
    type_address_proof: 'Address Proof (Ration / EB Bill)',
    type_pan_card: 'PAN Card',
    type_other_id: 'Other ID / Voter / Driving Licence',
    type_customer_photo: 'Customer Photograph',
    type_signature: 'Signature Specimen',
    type_thumb: 'Thumb Impression',
    type_pledge_photo: 'Jewellery Article Photo',
    type_pawn_ticket: 'Signed Pawn Ticket PDF',
    type_supporting_doc: 'Supporting Document / Invoice',
    rotate_left: '↺ Rotate Left',
    rotate_right: '↻ Rotate Right',
    replace_doc: 'Replace Document',
    archive_doc: 'Archive Document',
    restore_doc: 'Restore Document',
    rename_doc: 'Rename Document Title',
    upload_doc: 'Upload Document',
    scan_doc: 'Scan Document',
    customer_photo: 'Customer Photo',
    kyc_checklist: 'Customer KYC Verification Checklist',
    kyc_checklist_title: 'Customer KYC Verification Health',
    kyc_proofs: 'KYC & ID Proofs',
    photos_signatures: 'Photos & Signatures',
    all_documents: 'All Documents',
    doc_repository: 'Secure Document Repository',
    camera_permission_denied: 'Camera permission denied or camera not available.',
    snap_photo: 'Capture Scan',
    kyc_complete: '✓ Full KYC Verified',
    kyc_incomplete: '⚠ KYC Incomplete',
    kyc_photo_done: 'Customer Photo Captured',
    kyc_photo_missing: 'Customer Photo Missing',
    kyc_id_done: 'ID Proof Submitted',
    kyc_id_missing: 'ID Proof Missing',
    kyc_sign_done: 'Signature / Thumb Captured',
    kyc_sign_missing: 'Signature / Thumb Missing',
    kyc_addr_done: 'Address Proof Submitted',
    kyc_addr_missing: 'Address Proof Missing',
    file_type_error: 'Invalid file type. Allowed: JPG, PNG, WEBP, PDF',
    file_size_error: 'File size exceeds limit (Max 15MB)',
    upload_success: 'Document uploaded securely to Google Drive',
    replace_success: 'Document replaced successfully',
    archive_success: 'Document archived successfully',
    rename_success: 'Document title updated',
    pdf_preview_secured: 'PDF Document (Secured View)',
  ...
  ta: {
    ...
    data_health: 'தர பரிசோதனை & காப்புநகல்',
    settings: 'அமைப்புகள்',
    logout: 'வெளியேறு',
    ...
    kpi_today_renewals: 'இன்றைய புதுப்பித்தல்கள்',
    ...
    kpi_due_3days: 'அடுத்த 3 நாட்களில் கெடு',
    kpi_due_7days: 'அடுத்த 7 நாட்களில் கெடு',
    kpi_overdue: 'காலாவதியானவை (>12 மாதங்கள்)',
    kpi_missing_kyc: 'விடுபட்ட KYC',
    kpi_missing_customer_photo: 'விடுபட்ட புகைப்படம்',
    kpi_missing_pledge_photo: 'விடுபட்ட நகை புகைப்படம்',
    kpi_offline_queue: 'ஆஃப்லைன் வரிசை',
    kpi_failed_sync: 'தோல்வியுற்ற ஒத்திசைவு',
    kpi_rate_update: 'விலை நிலை',
    kpi_backup_status: 'காப்புப் பிரதி நிலை',
    omni_search_placeholder: 'விரைவு தேடல் (அடகு எண், பெயர், கைபேசி, ஆதார், பாக்கெட்)...',
    quick_new_customer: '+ புதிய வாடிக்கையாளர்',
    quick_new_pledge: '+ புதிய அடகு',
    quick_payment: 'பணம் வசூல்',
    quick_redemption: 'மீட்பு',
    quick_renewal: 'புதுப்பித்தல்',
    quick_search: 'உடனடி தேடல்',
    system_health_title: 'கணினி நிலை & இயக்கம்',
    document_alerts_title: 'ஆவணங்கள் & இணக்க எச்சரிக்கைகள்',
    rate_ticker_title: 'சந்தை விலை',
    ...
    retake_photo: 'மறுபடியும் எடு',
    confirm_photo: 'புகைப்படத்தை சேமி',
    cancel_photo: 'ரத்து செய்',
    take_snapshot: 'படம் பிடி',
    camera_permission_denied: 'கேமரா அனுமதி மறுக்கப்பட்டது அல்லது கேமரா கிடைக்கவில்லை. கேமரா அணுகலை அனுமதிக்கவும் அல்லது கோப்பு பதிவேற்றத்தைப் பயன்படுத்தவும்.',
    customer_photo_updated: 'வாடிக்கையாளர் புகைப்படம் வெற்றிகரமாக புதுப்பிக்கப்பட்டது',
    photo_sync_pending: 'புகைப்படம் உள்ளூரில் சேமிக்கப்பட்டது (கிளவுட் ஒத்திசைவு நிலுவையில் உள்ளது)',
    photo_sync_success: 'புகைப்படம் கூகுள் டிரைவில் பதிவேற்றப்பட்டது',
    no_camera_available: 'இந்த சாதனத்தில் கேமரா கண்டறியப்படவில்லை. கோப்பிலிருந்து புகைப்படத்தைப் பதிவேற்றவும்.',
    align_face_guide: 'முகத்தை வழிகாட்டி வளையத்திற்குள் வைக்கவும்',
    ...
    payment_methods_config: 'பணம் செலுத்தும் முறைகள் கட்டமைப்பு',
    payment_methods_desc: 'பணம் செலுத்தும் முறைகளை இயக்கவும், காட்சிப் பெயர்களை மாற்றவும் மற்றும் விதிகளை அமைக்கவும்.',
    enable_payment_method: 'முறையை இயக்கு',
    method_code: 'முறையின் குறியீடு',
    method_label_en: 'காட்சிப் பெயர் (ஆங்கிலம்)',
    method_label_ta: 'காட்சிப் பெயர் (தமிழ்)',
    ref_rule: 'பரிவர்த்தனை எண் விதி',
    ref_optional: 'விருப்பமானது',
    ref_recommended: 'பரிந்துரைக்கப்படுகிறது',
    ref_required: 'கட்டாயம் தேவை',
    notes_rule: 'குறிப்புகள் விதி',
    notes_optional: 'விருப்பமானது',
    notes_required: 'கட்டாயம் தேவை',
    mode_cash: 'ரொக்கம் (Cash)',
    mode_upi: 'யுபிஐ (GPay / PhonePe / Paytm)',
    mode_bank: 'வங்கி பரிவர்த்தனை (IMPS / NEFT)',
    mode_bank_transfer: 'வங்கி பரிமாற்றம் (IMPS / NEFT / RTGS)',
    mode_card: 'கார்டு (டெபிட் / கிரெடிட்)',
    mode_other: 'இதர முறை',
    collections_by_method: 'இன்றைய முறைவாரியான வசூல்',
    col_cash: 'ரொக்க வசூல்',
    col_upi: 'யுபிஐ வசூல்',
    col_bank: 'வங்கி பரிமாற்ற வசூல்',
    col_card: 'கார்டு வசூல்',
    col_other: 'இதர வசூல்',
    err_ref_required: 'இந்த கட்டண முறைக்கு பரிவர்த்தனை எண் கட்டாயம் தேவை',
    err_notes_required: 'இந்த கட்டண முறைக்கு குறிப்புகள் கட்டாயம் தேவை',
    err_no_payment_method: 'குறைந்தது ஒரு கட்டண முறையாவது இயக்கப்பட்டிருக்க வேண்டும்',
    ...
    // Advanced Valuation & Appraiser Fee Terms (Tamil)
    valuation_settings: 'மதிப்பீடு & கட்டண அமைப்புகள்',
    gold_appraiser_fee: 'நகை மதிப்பீட்டாளர் கட்டணம்',
    other_configured_fee: 'இதர கட்டணம்',
    gross_estimated_value: 'மொத்த சந்தை மதிப்பு',
    gross_eligible_value: 'மொத்த தகுதி மதிப்பு',
    less_fees: 'கட்டணக் கழிவு (-)',
    net_eligible_value: 'நிகர தகுதி மதிப்பு',
    ltv_percent: 'கடன் விகிதம் (LTV %)',
    max_loan: 'அதிகபட்ச தகுதியான கடன்',
    approved_pledge_amount: 'வழங்கப்படும் கடன் தொகை',
    net_disbursed_cash: 'வழங்கப்படும் நிகர ரொக்கம்',
    fee_deduction_mode: 'கட்டணம் பெறும் முறை',
    deduct_from_disbursement: 'வழங்கும் தொகையில் கழிக்கவும்',
    collect_separately: 'தனியாக ரொக்கமாக பெறவும்',
    appraiser_fee_type: 'மதிப்பீட்டாளர் கட்டண வகை',
    fee_type_fixed: 'நிலையான தொகை (₹)',
    fee_type_percentage: 'சதவீதம் (%)',
    fee_type_none: 'கட்டணம் இல்லை (₹0)',
    allow_per_pledge_custom_fee: 'ஒவ்வொரு அடகிற்கும் கட்டணம் மாற்ற அனுமதி',
    fee_deducted_disbursement_note: 'மதிப்பீட்டாளர் கட்டணம் கடன் தொகையில் கழிக்கப்பட்டது',
    fee_collected_counter_note: 'மதிப்பீட்டாளர் கட்டணம் தனியாக பெறப்பட்டது',
    ...
    // Document Repository & KYC Scanning Terms (Tamil)
    doc_repository: 'பாதுகாப்பான ஆவண காப்பகம்',
    upload_doc: 'ஆவணம் ஏற்று / ஸ்கேன் செய்',
    scan_document: 'ஆவணத்தை ஸ்கேன் செய் / படம் பிடி',
    document_scanner: 'ஆவண ஸ்கேனர் & கேமரா கருவி',
    type_aadhaar: 'ஆதார் அட்டை (அடையாள சான்று)',
    type_address_proof: 'முகவரி சான்று (குடும்ப அட்டை / EB பில்)',
    type_pan_card: 'பான் கார்டு (PAN)',
    type_other_id: 'இதர அடையாள சான்று / வாக்காளர் / ஓட்டுநர் உரிமம்',
    type_customer_photo: 'வாடிக்கையாளர் புகைப்படம்',
    type_signature: 'கையொப்ப மாதிரி',
    type_thumb: 'கைரேகை பதிவு',
    type_pledge_photo: 'நகை பொருள் புகைப்படம்',
    type_pawn_ticket: 'கையொப்பமிட்ட அடகு சீட்டு (PDF)',
    type_supporting_doc: 'துணை ஆவணம் / ரசீது',
    rotate_left: '↺ இடப்பக்கம் சுழற்று',
    rotate_right: '↻ வலப்பக்கம் சுழற்று',
    replace_doc: 'ஆவணத்தை மாற்று',
    archive_doc: 'ஆவணத்தை காப்பகப்படுத்து',
    restore_doc: 'ஆவணத்தை மீட்டெடு',
    rename_doc: 'ஆவணப் பெயரை மாற்று',
    upload_doc: 'ஆவணம் ஏற்று',
    scan_doc: 'ஆவணம் ஸ்கேன் செய்',
    customer_photo: 'வாடிக்கையாளர் புகைப்படம்',
    kyc_checklist: 'வாடிக்கையாளர் KYC சரிபார்ப்பு பட்டியல்',
    kyc_checklist_title: 'வாடிக்கையாளர் KYC சரிபார்ப்பு நிலை',
    kyc_proofs: 'KYC & அடையாள சான்றுகள்',
    photos_signatures: 'புகைப்படங்கள் & கையொப்பங்கள்',
    all_documents: 'அனைத்து ஆவணங்கள்',
    doc_repository: 'பாதுகாப்பான ஆவண காப்பகம்',
    camera_permission_denied: 'கேமரா அனுமதி மறுக்கப்பட்டது அல்லது கிடைக்கவில்லை.',
    snap_photo: 'படம் பிடி',
    kyc_complete: '✓ முழுமையான KYC சரிபார்க்கப்பட்டது',
    kyc_incomplete: '⚠ KYC ஆவண நிலுவை',
    kyc_photo_done: 'புகைப்படம் பெறப்பட்டது',
    kyc_photo_missing: 'புகைப்படம் விடுபட்டுள்ளது',
    kyc_id_done: 'அடையாள சான்று பெறப்பட்டது',
    kyc_id_missing: 'அடையாள சான்று விடுபட்டுள்ளது',
    kyc_sign_done: 'கையொப்பம் / கைரேகை பெறப்பட்டது',
    kyc_sign_missing: 'கையொப்பம் / கைரேகை விடுபட்டுள்ளது',
    kyc_addr_done: 'முகவரி சான்று பெறப்பட்டது',
    kyc_addr_missing: 'முகவரி சான்று விடுபட்டுள்ளது',
    file_type_error: 'தவறான கோப்பு வடிவம். அனுமதிக்கப்பட்டவை: JPG, PNG, WEBP, PDF',
    file_size_error: 'கோப்பின் அளவு அனுமதிக்கப்பட்ட வரம்பை தாண்டியுள்ளது (அதிகபட்சம் 15MB)',
    upload_success: 'ஆவணம் கூகுள் டிரைவில் பாதுகாப்பாக பதிவேற்றப்பட்டது',
    replace_success: 'ஆவணம் வெற்றிகரமாக மாற்றப்பட்டது',
    archive_success: 'ஆவண நிலை மாற்றப்பட்டது',
    rename_success: 'ஆவணப் பெயர் புதுப்பிக்கப்பட்டது',
    pdf_preview_secured: 'PDF ஆவணம் (பாதுகாக்கப்பட்ட பார்வை)',
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    I18nManager,
    translations,
    i18n: typeof window !== 'undefined' && window.i18n ? window.i18n : new I18nManager()
  };
}
